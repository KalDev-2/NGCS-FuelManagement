...
namespace FCS.Areas.Administrator.Controllers
{
    ...
    public class MenuTypesController : Controller
    {
        ...
        public MenuTypesController(FCSContext context)
        {
            _context = context;
        }
        [HttpPost]
        ...
        //{
              //return View(await _context.MenuTypes.Where(x=>!x.IsDeleted).ToListAsync());
        //}
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'FCSContext.MenuTypes'  is null.");
            }
            var menuType = await _context.MenuTypes.FindAsync(id);
            if (menuType != null)
            {
