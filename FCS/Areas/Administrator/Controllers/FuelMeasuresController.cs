...
namespace FCS.Areas.Administrator.Controllers
{
    ...
    public class FuelMeasuresController : Controller
    {
        ...
        public FuelMeasuresController(FCSContext context) 
        {
            _context = context;
        }
        [HttpPost]
        ...
        //{
            //var FCSContext = _context.FuelMeasures.Include(f => f.ActionByNavigation).Include(f => f.ApprovedByNavigation).Include(f => f.FuelType).Include(f => f.GasStation);
            //return View(await FCSContext.ToListAsync());
        //}
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'FCSContext.FuelMeasures'  is null.");
            }
            var fuelMeasure = await _context.FuelMeasures.FindAsync(id);
            if (fuelMeasure != null)
            {
